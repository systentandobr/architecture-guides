// Design Tokens - Sistema de Design Systentando
// Paleta de cores moderna e profissional

export const designTokens = {
  // Cores primárias - Sistema principal
  colors: {
    // Cores de marca
    primary: {
      50: '#f0f9ff',
...
// Utilitários para acessar os tokens
export const getColorToken = (color, shade = 500) => {
  return designTokens.colors[color]?.[shade] || designTokens.colors.neutral[500];
};
...
export const getFontSizeToken = (size) => {
